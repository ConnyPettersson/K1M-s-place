  ...
  return (
    <div className="flex flex-col max-w-2xl mx-auto w-full justify-center min-h-screen bg-white">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen">
        ...
        />
        <button
          className="visible-border bg-white text-black border-2 p-2 rounded hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
          onClick={() => router.push('/app/chat')}
        >
          Börja chatta
        </button>
        <button
          className="mt-2 visible-border bg-white text-black border-2 p-2 rounded hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
